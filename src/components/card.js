...
const ProductCard = ({name, price}) => {
  return (
    <div className="w-full h-auto rounded-lg shadow-sm border ">
      <img
      ...
      />
      <div className=" w-full p-4 h-auto flex flex-col justify-between gap-6 ">
        ...
        <div className="flex justify-between items-center ">
          ...
          <div className=" flex items-center gap-x-6 w-[fit-content] ">
            <a
              ...
              target="blank"
              className=" text-center rounded-md text-base  px-3 py-1.5  font-medium text-white shadow-sm bg-[#0E6B66] flex items-center gap-2"
            >
