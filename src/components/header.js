...
export default function Header() {
  ...
  return (
    <header className="inset-x-0 top-0 z-50 w-full fixed   bg-[#0E6B66]">
      ...
      <a
        className="text-white bg-[#24CC63] px-3 py-2 rounded-full w-max flex gap-[6px]  items-center justify-center h-10 fixed z-50 bottom-6 right-6 "
      ...
      >
        ...
        <p className="font-medium text-base">Chat here</p>
      </a>
    </header>
  );
}
